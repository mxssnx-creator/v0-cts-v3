...
export function ConfigurationSetManager({ configSets, presetTypes, onRefresh }: ConfigurationSetManagerProps) {
  const [selectedSet, setSelectedSet] = useState<PresetConfigurationSet | null>(null)

  const handleCreate = () => {
    toast.info("Configuration set creation coming soon")
  }
