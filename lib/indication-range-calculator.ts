...
/**
 * Calculate 50% range from default value
 */
export function calculateRange(defaultValue: number): IndicationParameterRange {
...
export const INDICATOR_DEFAULTS = {
  rsi: {
    period: calculateRange(14), // 7-21, step 1
    oversold: calculateRange(30), // 15-45, step 1
    overbought: calculateRange(70), // 35-105, step 1 (capped at 100 in UI)
  },
  macd: {
    fastPeriod: calculateRange(12), // 6-18, step 1
    slowPeriod: calculateRange(26), // 13-39, step 1
    signalPeriod: calculateRange(9), // 4.5-13.5, step 1
  },
  bollinger: {
    period: calculateRange(20), // 10-30, step 1
    stdDev: calculateRange(2), // 1-3, step 0.5
  },
  sar: {
    acceleration: calculateRange(0.02), // 0.01-0.03, step 0.01
    maximum: calculateRange(0.2), // 0.1-0.3, step 0.1
  },
  adx: {
    period: calculateRange(14), // 7-21, step 1
    threshold: calculateRange(25), // 12.5-37.5, step 1
  },
  ema: {
    period: calculateRange(20), // 10-30, step 1
  },
  ...
  stochastic: {
    kPeriod: calculateRange(14), // 7-21, step 1
    dPeriod: calculateRange(3), // 1.5-4.5, step 0.5
    smooth: calculateRange(3), // 1.5-4.5, step 0.5
  },
  atr: {
    period: calculateRange(14), // 7-21, step 1
  },
