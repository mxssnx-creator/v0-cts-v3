...
CREATE TABLE IF NOT EXISTS presets (
  ...
  -- Strategy types
  strategy_types JSONB DEFAULT '["base", "partial", "count"]'::jsonb,
  last_positions_counts JSONB DEFAULT '[3, 4, 5, 6, 8, 12, 25]'::jsonb,
  partial_positions_counts JSONB DEFAULT '[1, 2, 3, 4, 5]'::jsonb,
...
CREATE TABLE IF NOT EXISTS preset_strategies (
  ...
  strategy_type VARCHAR(20) NOT NULL, -- base, partial, count
