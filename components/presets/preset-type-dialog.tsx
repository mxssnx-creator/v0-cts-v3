      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="border-t pt-4 space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label>Block Strategy Enabled</Label>
                <p className="text-sm text-muted-foreground">Enable block trading strategy</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch checked={blockOnly} onCheckedChange={setBlockOnly} disabled={!blockEnabled} />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch checked={dcaOnly} onCheckedChange={setDcaOnly} disabled={!dcaEnabled} />
            </div>
          </div>
        </div>
