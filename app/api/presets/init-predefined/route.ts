...
const PREDEFINED_PRESETS = [
  {
    ...
    trail_stops: [0.2, 0.3],
    strategy_types: ["base", "partial"],
    last_positions_counts: [5, 6, 8],
    partial_positions_counts: [2, 3],
  ...
  },
  {
    ...
    strategy_types: ["base", "partial", "count"],
    last_positions_counts: [3, 4, 5, 6, 8, 12],
    partial_positions_counts: [1, 2, 3, 4],
  ...
  },
  {
    ...
    partial_positions_counts: [1, 2, 3, 4, 5],
    block_adjustment_enabled: true,
    block_sizes: [2, 4, 6, 8],
  ...
  },
  {
    ...
    trail_starts: [0.6, 1.0],
    trail_stops: [0.2, 0.3],
    strategy_types: ["base", "count"],
    last_positions_counts: [6, 8, 12, 25],
    partial_positions_counts: [2, 3, 4],
    block_adjustment_enabled: true,
    block_sizes: [4, 6, 8],
    block_adjustment_ratios: [1.0, 1.5, 2.0],
    dca_adjustment_enabled: true,
      ...
      try {
        ...
        await sql`
          ...
          VALUES (
            ...
            ${JSON.stringify(preset.partial_positions_counts)},
